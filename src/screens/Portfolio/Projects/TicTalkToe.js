...
// Info needs to be filled out, image needs to be changed, and heroku serving needs to be fixed.
...
export default function TicTalkToe() {
  ...
  return (
    <Card sx={{ maxWidth: 445 }}>
      <CardActionArea href="https://tictalktoe.herokuapp.com/" target="blank">
        <CardHeader
          avatar={
            <Avatar sx={{ bgcolor: red[500] }} aria-label="TicTalkToe">
              T3
            </Avatar>
          }
          title="Tic-Talk-Toe"
          subheader="Social Gaming Platform"
        />
        <CardMedia component="img" height="194" image={mtg} alt="TicTalkToe" />
        <CardContent>
